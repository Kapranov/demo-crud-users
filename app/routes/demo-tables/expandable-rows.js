...
export default DemoTableRoute.extend({
  ...
  actions: {
    didTransition() {
      set(this, 'controller.expandAllToggleTemplate',
          `<a href="#" {{action "expandAllRows" bubbles=false}} class={{themeInstance.expandAllRows}}>
      ...
      set(this, 'controller.expandToggleTemplate',
          `{{#if isExpanded}}
